...
export default function Head() {
  ...
  <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center cursor-pointer font-semibold">
      ...
      <a className="mr-5 text-[#2D3748] hover:text-[#667EEA]">PORTFOLIO</a>
      <a className="mr-5 text-[#2D3748] hover:text-[#667EEA]">CATEGORY</a>
      <a className="mr-5 text-[#2D3748] hover:text-[#667EEA]">BLOG</a>
    </nav>
    <button className="inline-flex items-center bg-gray-100 text-[#2D3748] border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">CART
